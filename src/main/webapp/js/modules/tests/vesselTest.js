define([ "hasher", "sinon", "knockout", "jasmine-jquery" ], function(hasher,
  ...
  describe("Manage Vessels", function() {
    ...
    beforeEach(function() {
      ...
      /*
       * wait for the use case to appear. There might be several async responses
       * going on; therefore call server.respond() repeatedly.
       */
      waitsFor(function() {
        server.respond();
        // console.log($("#vesselList"));
        return $("#vesselList").is(":visible");
      }, "the list to appear", 5000);
      // END SNIPPET: jasminesinon4

      waitsFor(function() {
        return $("#vesselList > tbody > tr").length == 2;
      }, "the list to be filled", 2000);
